...
def exp1():
    ...
    print filter_badges
    Parallel(n_jobs=num_cores/2)(delayed(wiki_comparison.experiment_1)(badge, path, 24) for badge in filter_badges)
    Parallel(n_jobs=num_cores/2)(delayed(wiki_comparison.experiment_1)(badge, path, 12) for badge in filter_badges)
    Parallel(n_jobs=num_cores/2)(delayed(wiki_comparison.experiment_1)(badge, path, 6) for badge in filter_badges)
    Parallel(n_jobs=num_cores/2)(delayed(wiki_comparison.experiment_1)(badge, path, 4) for badge in filter_badges)
...
def exp3():
    ...
    print 'Experiment 3'
    print filter_badges
    Parallel(n_jobs=num_cores/2)(delayed(wiki_comparison.experiment_3)(badge, path, 24) for badge in filter_badges)
    Parallel(n_jobs=num_cores/2)(delayed(wiki_comparison.experiment_3)(badge, path, 12) for badge in filter_badges)
    Parallel(n_jobs=num_cores/2)(delayed(wiki_comparison.experiment_3)(badge, path, 6) for badge in filter_badges)
    Parallel(n_jobs=num_cores/2)(delayed(wiki_comparison.experiment_3)(badge, path, 4) for badge in filter_badges)
